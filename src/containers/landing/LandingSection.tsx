  ...
  return (
    <div className='flex flex-col md:flex-row w-full items-center'>
      <div className='h-screen-64 w-full md:w-1/2 flex justify-center flex-col p-4 md:p-0'>
        ...
        <button className='max-w-max mt-6 border px-4 py-2 rounded-md font-bold text-red-500 border-red-500 hover:text-white hover:bg-red-500'>Get to know me</button>
      </div>
