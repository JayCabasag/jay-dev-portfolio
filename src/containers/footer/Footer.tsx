...
export default function Footer() {
  ...
  return (
    <nav className='bg-white h-16 shadow-xs w-full flex justify-center'>
      <div className='container'>
        <div className="sm:flex sm:items-center sm:justify-between md:p-0">
          <span className="text-md text-gray-500 sm:text-center dark:text-gray-400">
            © {year}
          <a href="#" className="hover:underline font-bold">jay.dev</a>.
            All Rights Reserved.
          </span>
          <div className="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
              <a href="https://www.facebook.com/Jay.Cabasag99/" target='_blank' className="text-gray-500 hover:text-gray-900 dark:hover:text-white">
              ...
              <a href="https://www.instagram.com/jhie_bluedev/" target='_blank' className="text-gray-500 hover:text-gray-900 dark:hover:text-white">
              ...
              <a href="https://twitter.com/jhie_BlueDev" target='_blank' className="text-gray-500 hover:text-gray-900 dark:hover:text-white">
              ...
              <a href="https://github.com/JayCabasag" target='_blank' className="text-gray-500 hover:text-gray-900 dark:hover:text-white">
